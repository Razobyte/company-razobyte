        ...
        <Col md={10}>
          ...
          md:ml-[100px]'>
            ...
            <p className='d-flex align-items-center gap-1'>
              <a href="mailto:contact-us@razobyte.com" className="text-light"><CiMail size={20} /></a>
              contact-us@razobyte.com
            </p>
            <p className='d-flex align-items-center gap-1'>
              <a href="tel:+918448158188" className="text-light"><FaPhoneAlt size={20} /></a>
              +91-8448158188
            </p>
          </div>
        </Col>
