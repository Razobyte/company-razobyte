...
import headerLogo from '../../../../public/Image/COMPANY LOGO -razobyte-01 (1).png'
...
const Navbar = ({openmodel}) => {
  ...
  const content =
    ...
    <div className="lg:hidden z-1000 block absolute top-26 h-[90vh] w-50  right-0 bg-white backdrop-blur-lg bg-opacity-30  py-3">
      <ul className="flex flex-col gap-[25px] text-[18px] items-center ">
        <Link to='/' className='no-underline navlinkmenutitle '>
         <li className='hover:text-[#3B7FBF]  cusror-pointer text-[#5e5e5e] '>Home</li></Link>
        {/* Mega Menu Start*/}
        <div className="group">
  ...
  return (
    <>
      <nav className="z-50 bg-white navmaindiv w-[100%]">
        <div className=" flex items-stretch  w-[100%] m-auto py-4">
          <div className="flex items-center  justify-center ps-5">
            <img src={headerLogo} alt="logo" className=" img-fluid md:cursor-pointer" />
          </div>
          <div className="lg:flex  md-flex flex-1 items-stretch justify-center  font-normal hidden for-gap">
            <ul className="flex items-center justify-center mb-0 ">
              ...
              <div className="group">
                <li className="navlinkmenutitle no-underline disable">
                  ...
                  >About </span>
                  {aboutmenu ? (
                    <FaAngleDown className="text-[#5e5e5e] mx-lg-1 mx-md-1 mx-xl-1 mx-sm-0 mx-1 inline-block" onClick={handleAboutMenu} />
                  ) : (
                    <FaAngleUp className="text-[#5e5e5e] mx-lg-1 mx-md-1 mx-xl-1 mx-sm-0 mx-1 inline-block" onClick={handleAboutMenu} />
                  )}
                </li>
                {aboutmenu ? (
                  <>
    ...
    rounded-1 shadow-lg bg-gray-100 z-20 text-black duration-300 "
              ...
              <div className="group">
                <li className="navlinkmenutitle no-underline disable">
                  ...
                  > Services</span>
                  {active ? (
                    <FaAngleDown className="text-[#5e5e5e] mx-lg-1 mx-md-1 mx-xl-1 mx-sm-0 mx-1 inline-block" onClick={handleActive} />
                  ) : (
                    <FaAngleUp className="text-[#5e5e5e] mx-lg-1 mx-md-1 mx-xl-1 mx-sm-0 mx-1 inline-block" onClick={handleActive} />
                  )}
                </li>
                {active ? (
                  <>
 ...
 navlinkmenutitle '>Portfolio  </Link></li>
              ...
              <li>
              <a href="tel:+918448158188" className='no-underline  hover:no-underline flex items-center gap-2 hover:text-[#3b7fbfbe]  cursor-pointer text-[#3b7fbf] text-[18px] font-[500] '>
              <MdPhoneInTalk size={30} className="rounded-5 bg-[#3b7fbf]  text-white p-1" />
              8448158188
            </a>
            
              </li>  
              <Button className="btnmain" onClick={openmodel}>Get a Quote</Button>
          ...
          <div>
            ...
            <button className="block sm:hidden ps-5 "
              onClick={handleClick}>
              {click ? <GrClose size={30} className="my-3" />

                : <HiMenuAlt2 size={30} className="mt-3" />}
            </button>
          </div>
        </div>
        {click && content}
