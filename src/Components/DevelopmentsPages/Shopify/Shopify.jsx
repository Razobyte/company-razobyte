    ...
    <>
      <Row className='flex justify-center items-center'>
        ...
        <Col md  lg xxl className='px-0'>
          ...
          <div className='absolute absolute top-lg-50 top-md-20 top-[170px] left-20 w-[50%]'>
            <h2 className='hed1 text-[#3b7fbf]'>Shopify Development</h2>
            <p className='hed3 text-left font-[550] d-md-block d-none'>Kick-start your business by launching  <br/>an  e-commerce store
              with Shopify</p>
